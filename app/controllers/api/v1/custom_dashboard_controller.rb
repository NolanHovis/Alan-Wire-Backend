module Api
	module V1
		class CustomDashboardController < Api::V1::ApplicationController
			...
			def create
				result = CustomDashboard.new_custom_dashboard(custom_dashboard_params, @current_user)
			...
			def destroy
				result = CustomDashboard.destroy_custom_dashboard(params[:id], @current_user)
